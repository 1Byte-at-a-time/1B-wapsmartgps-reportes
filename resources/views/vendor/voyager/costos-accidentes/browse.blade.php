                                 ...
                                 <tbody>
                                    @foreach ($dataTypeContent as $data)
                                        ...
                                        switch ($profile->role_id) {
                                            ...
                                            case 2: //admin center
                                                if (isset($profile->center_id)) {
                                                   // var_dump($data);
                                                    if ($profile->center_id != $data->center_id) {
                                                        continue 2;
                                                    }
                                                } else {
                                                    continue 2;
