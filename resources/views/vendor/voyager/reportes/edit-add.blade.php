                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @if (isset($row->details->section))
                                    <div class="panel-section col-md-12">
                                        <h3 class="d-inline-block" style="display: inline-block;">{{ $row->details->section }}</h3>
                                        <button type="button" class="btn btn-secondary d-inline-block d-all" style="display: inline-block;" value="{{$display_options->id}}">Seleccionar todos</button>
                                    </div>
                                @endif
...
@section('javascript')
    ...
    <script>
        ...
        $('document').ready(function () {
            ...
            /*Timestamp by jquery*/
            $( "input[name*='time_report']" ).parent().hide();
            $( "input[name*='time_report']" ).data("DateTimePicker").show();
            /*Timestamp by jquery*/
            
            $( ".d-all" ).click(function() {
                if($( this ).val()=="bef_oil"){
                    $( "input[name*='bef_level']" ).parent().click();
                }
                $( "input[name*='"+$( this ).val()+"']" ).parent().click();
            });
